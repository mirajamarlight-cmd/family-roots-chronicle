  ...
  head: () => ({
    meta: [
      { title: SITE_NAME },
      {
        name: "description",
        content:
          "Explore the Feqi Yonis family tree: navigate generations, expand branches and open any relative's profile.",
      },
      { property: "og:title", content: SITE_NAME },
      {
        property: "og:description",
        content: "An interactive record of the Feqi Yonis family across generations.",
      },
    ],
  }),
  component: TreePage,
      ...
      <div className="tree-page flex flex-col overflow-hidden">
        ...
        {isLoading && (
          <div className="flex h-full items-center justify-center gap-2 text-muted-foreground">
            <Loader2 className="size-4 animate-spin" /> Loading {SITE_NAME}…
          </div>
        )}
        {error && (
